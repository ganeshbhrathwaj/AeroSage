...
def transfer_file_from_github_to_s3(github_url, bucket_name, s3_file_name):
    s3 = boto3.client('s3')
...
pre_processing_job = SageMakerProcessingOperator(
        ...
        config={
            ...
            "RoleArn": "arn:aws:iam::654654507899:role/service-role/AmazonSageMaker-ExecutionRole-20240302T142280",
        },
        aws_conn_id="aws_default",
...
deploy_job =  SageMakerModelOperator(
    ...
    config={
        ...
        "ExecutionRoleArn": "arn:aws:iam::654654507899:role/service-role/AmazonSageMaker-ExecutionRole-20240302T142280",
    },
    aws_conn_id="aws_default", 
    dag = dag
)
